...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_url', type=str, default='/cache/pretrain', help='the input data path')
    parser.add_argument('--model_name_or_path', type=str, default='/home/ma-user/work/zhangfanrui/model/lmsys_vicuna-7b-v1.5', help='the input data path')
