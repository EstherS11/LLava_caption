...
def prepare_data():
    ...
    print('data 准备完成')
# mox.file.copy_parallel('s3://doclm/zhaojie/interns/zhangfanrui/llava_modelarts/data/json/qa_pairs_caption_v2.json', '/home/ma-user/work/zhangfanrui/data/json/qa_pairs_caption_v2.json')
