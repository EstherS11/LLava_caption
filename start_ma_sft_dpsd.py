...
## mox.file.copy_parallel('s3://doclm/zhaojie/interns/zhangfanrui/llava_modelarts/data/json/qa_pairs_merged_clean_v2.json', '/cache/qa_pairs_merged_clean_v2.json')

## mox.file.copy_parallel('/cache/llava_sft_caption_lora_10e_0630', 's3://doclm/zhaojie/interns/zhangfanrui/out/llava_sft_caption_lora_10e_0630')
## mox.file.copy_parallel('/cache/llava_4o_fogery_merge_v2_5e_0630', 's3://doclm/zhaojie/interns/zhangfanrui/out/llava_4o_fogery_merge_v2_5e_0630')
# mox.file.copy_parallel('s3://doclm/zhaojie/interns/zhangfanrui/out/llava_sft_caption_lora_10e_0630','/cache/llava_sft_caption_lora_10e_0630')
# mox.file.copy_parallel('s3://doclm/zhaojie/interns/zhangfanrui/out/llava_4o_fogery_merge_v2_5e_0630','/cache/llava_4o_fogery_merge_v2_5e_0630')
if __name__ == '__main__':
    ...
    parser.add_argument('--save_steps', type=int, default=10000, help='world size')
    ...
    parser.add_argument('--mm_projector_lr', type=float, default=2e-5, help='world size')
    parser.add_argument('--master_port', type=str, default='8524', help='the input data path')
    args, unparsed = parser.parse_known_args()

    # os.system('nvcc --version')
    os.environ['CUDA_VISIBLE_DEVICES'] = '0,1,2,3,4,5,6,7'  # 指定使用 GPU 卡 0
    ...
    # os.system('pip list')
    # breakpoint()   
    cmd = f"deepspeed llava/train/train_xformers.py \
