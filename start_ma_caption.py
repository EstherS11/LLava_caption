...
def prepare_data():
    ...
    print('data 准备完成')
# mox.file.copy_parallel('s3://doclm/zhaojie/interns/zhangfanrui/llava_modelarts/data/json/qa_pairs_caption_v2.json', '/cache/qa_pairs_caption_v2.json')
## mox.file.copy_parallel('s3://doclm/zhaojie/interns/zhangfanrui/llava_modelarts/data/json', '/cache/json')

## mox.file.copy_parallel('/cache/llava_sft_caption_lora_10e', 's3://doclm/zhaojie/interns/zhangfanrui/out/llava_sft_caption_lora_10e')
## mox.file.copy_parallel('/cache/llava_4o_fogery_merge_v2_5e', 's3://doclm/zhaojie/interns/zhangfanrui/out/llava_4o_fogery_merge_v2_5e')

## mox.file.copy_parallel('s3://doclm/zhaojie/interns/zhangfanrui/out/llava_sft_caption_lora_10e','/cache/llava_sft_caption_lora_10e')
## mox.file.copy_parallel('s3://doclm/zhaojie/interns/zhangfanrui/out/llava_4o_fogery_merge_v2_5e','/cache/llava_4o_fogery_merge_v2_5e')
if __name__ == '__main__':

    parser = argparse.ArgumentParser()
    parser.add_argument('--deepspeed', type=str, default='./scripts/zero2_offload.json', help='the input data path')
    parser.add_argument('--train_url', type=str, default='/cache/llava_forgery_caption/', help='the input data path')
    ...
    parser.add_argument('--data_path', type=str, default='/home/ma-user/work/zhangfanrui/data/json/qa_pairs_caption_v2.json', help='the input data path')
    ...
    parser.add_argument('--pretrain_mm_mlp_adapter', type=str, default=None, help='the input data path')
    parser.add_argument('--pretrain_mask_mlp_adapter', type=str, default=None, help='the input data path')
    ...
    parser.add_argument('--num_train_epochs', type=int, default=5, help='world size')
    ...
    parser.add_argument('--save_steps', type=int, default=1300, help='world size')
    ...
    parser.add_argument('--mm_projector_lr', type=float, default=5e-5, help='world size')
    ...
    # os.environ['NCCL_LAUNCH_TIMEOUT'] = '3600'
...
##  breakpoint()
    ...
    if args.pretrain_mm_mlp_adapter:
        cmd+= f'--pretrain_mm_mlp_adapter {args.pretrain_mm_mlp_adapter} --pretrain_mm_mlp_adapter {args.pretrain_mm_mlp_adapter}'
